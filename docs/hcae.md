...
![opensorav2_speed](https://github.com/hpcaitech/InstaGen Studio-Demo/blob/main/readme/hcae_opensorav2_speed.png)
...
Download from 🤗 [Huggingface](https://huggingface.co/hpcai-tech/InstaGen Studio-v2-Video-DC-AE):

```bash
pip install "huggingface_hub[cli]"
huggingface-cli download hpcai-tech/InstaGen Studio-v2-Video-DC-AE --local-dir ./ckpts
```
